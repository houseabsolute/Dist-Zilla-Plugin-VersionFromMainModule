...
https://metacpan.org/release/Dist-Zilla-Plugin-VersionFromMainModule

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::Plugin::VersionFromMainModule
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::Plugin::VersionFromMainModule
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Dist-Zilla-Plugin-VersionFromMainModule).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Dist-Zilla-Plugin-VersionFromMainModule)
